 ...
 * </p>
 * <ul>
 *   <li>{@link bowling.impl.GameImpl#getMatchups <em>Matchups</em>}</li>
...
public class GameImpl extends MinimalEObjectImpl.Container implements Game {
	...
	public Matchup getMatchups() {
		if (eContainerFeatureID() != BowlingPackage.GAME__MATCHUPS) return null;
	...
	public NotificationChain basicSetMatchups(Matchup newMatchups, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newMatchups, BowlingPackage.GAME__MATCHUPS, msgs);
		return msgs;
	}
	...
	public void setMatchups(Matchup newMatchups) {
		if (newMatchups != eInternalContainer() || (eContainerFeatureID() != BowlingPackage.GAME__MATCHUPS && newMatchups != null)) {
			if (EcoreUtil.isAncestor(this, newMatchups))
				throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			if (newMatchups != null)
				msgs = ((InternalEObject)newMatchups).eInverseAdd(this, BowlingPackage.MATCHUP__GAMES, Matchup.class, msgs);
			msgs = basicSetMatchups(newMatchups, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BowlingPackage.GAME__MATCHUPS, newMatchups, newMatchups));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BowlingPackage.GAME__MATCHUPS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetMatchups((Matchup)otherEnd, msgs);
		}

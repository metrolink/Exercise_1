...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	public EReference getGame_Matchups() {
	...
	public void createPackageContents() {
		...
		createEReference(gameEClass, GAME__MATCHUPS);
	...
	public void initializePackageContents() {
		...
		initEReference(getMatchup_Games(), this.getGame(), this.getGame_Matchups(), "games", null, 2, 2, Matchup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(gameEClass, Game.class, "Game", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGame_Matchups(), this.getMatchup(), this.getMatchup_Games(), "matchups", null, 0, 1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
